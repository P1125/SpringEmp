...
public class EmpSpringDAO {
	...
	private final String INSERT_EMP = "INSERT  INTO  EMPLOYEES( " + "	EMPLOYEE_ID," + " FIRST_NAME," + " LAST_NAME,"
			+ " EMAIL," + " HIRE_DATE" + " JOB_ID" + " DEPARTMENT_ID)" + " VALUES(?,?,?,?,?,?,?)";;

	private final String UPDATE_EMP = "UPDATE SET  EMPLOYEES( " + "	EMPLOYEE_ID," + " FIRST_NAME," + " LAST_NAME,"
			+ " EMAIL," + " HIRE_DATE" + " JOB_ID" + " DEPARTMENT_ID)" + " VALUES(?,?,?,?,?,?,?)";;
	...
	public int updateEmp(EmpVO vo) {
		int result = 0;
		result = jdbc.update(UPDATE_EMP, vo.getEmployee_id(), vo.getFirst_name(), vo.getLast_name(), vo.getEmail(),
				vo.getHire_date(), vo.getJob_id(), vo.getDepartment_id());
	...
	public int deleteEmp(EmpVO vo) {
		int result = 0;
		result = jdbc.update(DELETE_EMP, vo.getEmployee_id(), vo.getFirst_name(), vo.getLast_name(), vo.getEmail(),
				vo.getHire_date(), vo.getJob_id(), vo.getDepartment_id());
